...
# Training K-Nearest Neighbours model on the training set
...
# Visualising the training set results (compute-intensive visualisation)
...
# Visualising the test set results (compute-intensive visualisation)
